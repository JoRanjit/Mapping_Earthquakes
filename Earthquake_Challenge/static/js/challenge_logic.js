...
// We create a third tile layer - night navigation that will be the background of our map.
...
// We create a fourth tile layer - dark that will be the background of our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
    onEachFeature: function(feature,layer) {
      layer.bindPopup("<h3> Major Earthquake </h3> <hr> <h4> Magnitude: "+ feature.properties.mag +"<br> Location: " + feature.properties.place + "</h4>");
  }
...
/***** Tectonic Plates Layer *********/
  ...
  //Create a style for tectonic lines
let myStyle = {
  color: "#ea822c", 
  weight: 3
};
